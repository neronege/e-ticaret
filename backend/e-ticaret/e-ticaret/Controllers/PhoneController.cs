...
namespace e_ticaret.Controllers
{
    ...
    {
        private readonly IRepositoryPhone _repositoryService;

        public PhoneController(IRepositoryPhone repositoryService)
        {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] Phone model)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] Phone model)
        {
