...
namespace e_ticaret.Controllers
{
    ...
    {
        private readonly IRepositoryDress _repositoryService;

        public DressController(IRepositoryDress repositoryService)
        {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] Dress model)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] Dress model)
        {
