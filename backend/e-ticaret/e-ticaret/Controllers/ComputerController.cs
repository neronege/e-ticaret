...
namespace e_ticaret.Controllers
{
    ...
    {
        private readonly IRepositoryComputer _repositoryService;

        public ComputerController(IRepositoryComputer repositoryService)
        {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] Computer model)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] Computer model)
        {
