...
namespace e_ticaret.Controllers
{
    ...
    {
        private readonly IRepositoryTv _repositoryService;

        public TvController(IRepositoryTv repositoryService)
        {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] Tv model)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] Tv model)
        {
